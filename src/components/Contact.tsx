...
const Contact = () => {
    ...
    const socialLinks = [
        ...
        {
            name: 'LinkedIn',
            url: 'https://linkedin.com/in/ajit-gupta25',
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        {
            name: 'Twitter',
            url: 'https://x.com/unfiltered_ajit',
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        },
        {
            ...
            url: 'https://buymeacoffee.com/ajit_gupta',
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
